...
@implementation MQFloatButton {
    MQAssistiveTouchType  _type;
}

+ (instancetype)mn_touchWithFrame:(CGRect)frame{
    return [self mn_touchWithType:MQAssistiveTouchTypeNone
                            Frame:frame
                            title:nil
                       titleColor:nil
                        titleFont:nil
...
- (instancetype)initWithType:(MQAssistiveTouchType)type
                       frame:(CGRect)frame
                       title:(NSString *)title
                  titleColor:(UIColor *)titleColor
                   titleFont:(UIFont *)titleFont
...
- (void)changePostion:(UIPanGestureRecognizer *)pan{
    ...
    switch (_type) {
        case MQAssistiveTouchTypeNone:
        {
            ...
            break;
        }case MQAssistiveTouchTypeHorizontalScroll:{
            originalFrame = [self changeYWithFrame:originalFrame point:point];
            break;
        }
        case MQAssistiveTouchTypeVerticalScroll:{
            originalFrame = [self changeXWithFrame:originalFrame point:point];
            break;
        }
    }
